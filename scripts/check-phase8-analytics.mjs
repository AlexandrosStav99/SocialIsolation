...
for(const forbidden of ["sessionId","requestId","userId","contactDetail","freeText"]) {const block=domain.slice(domain.indexOf("export type AnonymousAnalyticsEvent"),domain.indexOf("export type ContactRequest"));if(block.includes(forbidden)) throw new Error("Anonymous analytics contains forbidden identifier: "+forbidden);}
